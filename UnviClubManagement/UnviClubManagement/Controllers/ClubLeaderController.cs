...
namespace UnviClubManagement.Controllers
{
    ...
    public class ClubLeaderController : ControllerBase
    {
        ...
        {
            var clubName = _db.Clubs
                .Where(c => c.ClubLeaderID == clubLeaderId)
                .Select(c => c.ClubName).First();

            var clubStatus = _db.Clubs
                .Where(c => c.ClubLeaderID == clubLeaderId)
                .Select(c => c.Status).First();
            ...
            var dashboardData = new
            {
                ...
                PendingClubMembers = pendingClubMembersCount,
                AcceptedClubMembers = acceptedClubMembersCount,
                TotalClubMembers = totalClubMembersCount,
                AcceptedEvents = acceptedEventsCount,
                PendingEventMembers = pendingEventMembersCount,
                AcceptedEventMembers = acceptedEventMembersCount
            };
